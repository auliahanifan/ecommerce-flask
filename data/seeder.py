...
def product_seed():
    try:
        ...
        black_shirt_product = Product(1, 2, 'Red Tee', 100, 50000, 500, 'https://cf.shopee.co.id/file/597343d149e477b96465773b464509e8', 'Kemeja Hitam Berkualitas')
        red_shirt_product = Product(1, 2, 'Red Tee', 100, 50000, 500, 'https://cf.shopee.co.id/file/711234d4eecc4236526b67f379a72a51', 'Kaos Merah Berkualitas')
...
def user_seed():
    try:
        ...
        # new_user = User('userbaru', 'userbaru', 'userbaru@userbaru.com')
